...
namespace Satellite.CoreUpdater
{
    ...
    public static class Program
    {
        ...
        /// naming `TiaSession` would try to load `Siemens.Engineering.Base` *before* its own
        /// first line ran - which is the line that installs the resolver. One method boundary
